...
const getAllVideos = asyncHandler(async (req, res) => {
  ...
  //YOU CAN INCLUDUE FIELD MAPPINGS IN SEARCH INDEX EG: TTITLE, DESCRIPTION AS WELL
  //FIELD MAPPINGS SPECIFY WHICH FIELDS WITHIN DOCUMENTS SHOULD BE INDEXED FOR TEXT SEARCH
  //THIS HELPS IN SEARCHING ONLY IN TITLE, DESCription PROVIDING FASTER SEARCH RESULTS
  //HERE THHE NAME OF SEARCH INDEX IS 'SEARCH-VIDEOS
...
const togglePublishStatus = asyncHandler(async (req, res) => {
  ...
  if (video?.owner.toString() !== req.user?._id.toString()) {
    throw new ApiError(400, "You can't toggle publish status");
  }
